...
Polygon-NFT now uses hardhat-deploy to manage deployments, see the /deploy folder
...
const main = async () => {
  ...
  */
  ...
  //If you want to verify your contract on tenderly.co (see setup details in the README!)
  /*
