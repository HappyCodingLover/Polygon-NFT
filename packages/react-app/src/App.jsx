...
function App(props) {
  ...
  // Polygon-NFT is full of handy hooks like this one to get your balance:
  ...
  */
  ...
  useEffect(() => {
    if (
      ...
      console.log("_____________________________________ Polygon-NFT _____________________________________");
